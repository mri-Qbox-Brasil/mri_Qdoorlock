...
const MriPopover = PopoverPrimitive.Root

const MriPopoverTrigger = PopoverPrimitive.Trigger

const MriPopoverContent = React.forwardRef<
...
MriPopoverContent.displayName = PopoverPrimitive.Content.displayName
