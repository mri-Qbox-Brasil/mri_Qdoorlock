...
const Switches: React.FC = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-2 pt-1">
      ...
      <TooltipSwitch label="Porta Dupla" tooltip={isBulkEdit ? "Não é possível alterar porta dupla em edição em massa" : "Habilitar se a porta alvo for uma porta dupla"} value={double || false} toggle={() => toggleCheckbox('doors')} disabled={isBulkEdit} />
